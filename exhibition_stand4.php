...
<body>
    ...
    ?>
        <div class='wrapper'>
            <h3>Stand 4 - 6</h3>
            <h2>Offline</h2>
            <p>Die Stände 4 bis 6 sind ohne Handy zu lösen!</p>
            <div class="infobox">
                ...
                <p>Probiere die Experimentierstationen aus und studiere die Tafeln!</p>
            </div>
            <form action="" method="post">
                <input type="submit" class="button" name="submit" value="Zum Stand 7 &rarr;">
...
<?php
        ...
        if (isset($_POST['submit'])) {
            ...
            header("Location: exhibition_stand7.php?user_id=$userId");
            exit;
        }
