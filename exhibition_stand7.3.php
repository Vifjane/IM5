...
<body>
    ...
    if (empty($_GET['user_id'])) {
        ...
        $selectQuery = "SELECT * FROM `progress` WHERE user_id='$userId' AND (stand7_3='2' OR stand7_3='3')";
    ...
    ?>
        <div class='wrapper'>
            ...
            <p>Schnuppere an dem Fläschchen namens "Duft 3" und wähle das Bild, welches für dich zum Duft passt?</p>
            ...
            <form action="" method="post" onsubmit="return validateForm()">
                <div class="buttons">
                    ...
                    <label for="image1" class="image-label"><img class="biggerImg" src="img\duft3_1.jpeg" alt="Frische Image"></label>
                    <input type="radio" name="image" value="2" id="image2">
                    <label for="image2" class="image-label"><img class="biggerImg" src="img\duft3_2.jpeg" alt="Entspannung Image"></label>
                    <input type="radio" name="image" value="3" id="image3">
                    <label for="image3" class="image-label"><img class="biggerImg" src="img\duft3_3.jpeg" alt="Abenteuer Image"></label>
                </div><!--ende buttons-->
...
<?php
        ...
        if (!empty($existingAnswer)) {
            ...
            $sql_progress = "UPDATE `progress` SET `stand7_3` = '1' WHERE `user_id` = '$userId'";
        ...
        $selectQuery = "SELECT * FROM `stand7_3`";
        $result = $connection->query($selectQuery);
        ...
        if (isset($_POST['submit'])) {
            ...
            if (in_array(['user_id' => $userId, 'duft3' => $imageDuft3], $existingStand7Duft, true)) {
                ...
                $sql = "UPDATE `stand7` SET `duft3` = '$imageDuft3' WHERE `user_id` = '$userId'";
                //Der Status des aktuellen Standes wird auf 2 (2=Antwort in DB gespeichert) aktualisiert
                $sql2 = "UPDATE `progress` SET `stand7_3` = '2' WHERE `user_id` = '$userId'";
                ...
                if ($connection->query($sql) === TRUE) {
                    ...
                    echo '<script>window.location.href = "exhibition_stand7_feedback.php?user_id=' . $userId . '";</script>';
                    exit;
                } else {
